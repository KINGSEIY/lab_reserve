...
<script>
    ...
    $(function(){
        ...
        $("#editTeacherInfo").bootstrapValidator({
            message: 'This value is not valid',
            feedbackIcons: {
                valid: 'glyphicon glyphicon-ok',
                invalid: 'glyphicon glyphicon-remove',
    ...
    function editUser() {
        var EditUser = $('#${tea.getUser_num()}');
        var bootstrapValidator = $("#editTeacherInfo").data("bootstrapValidator");
        bootstrapValidator.validate();
        ...
        EditUser.on("hide.bs.modal", function() {
            $("#editTeacherInfo").bootstrapValidator('resetForm');
        });
    }
    ...
    <div class="lyear-layout-container">
                    ...
                    <ul class="nav nav-drawer">
                        ...
                        <li class="nav-item nav-item-has-subnav active open">
                            ...
                            <ul class="nav nav-subnav">
                                ...
                                <li class="active"> <a href="/admin/manage_teachers" style="font-size: 15px;margin-left: 10px"><i class="glyphicon glyphicon-music tubiao"></i>   管理教师</a> </li>
        ...
        <main class="lyear-layout-content">
            ...
            <div class="container-fluid">
                <%--                  显示此管理员所在学院的所有教师信息，管理员具有删除教师和增加教师的权限--%>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-toolbar clearfix">
                                <form action="/admin/searchTeacherBySearch_text" method="post" class="pull-right search-bar" role="form">
                                ...
                                <div class="toolbar-btn-action">
                                    ...
                                    <a class="btn btn-secondary m-l-5 m-t-5" href="/admin/tomanage_teachers" ><i class="glyphicon glyphicon-share-alt "></i> 返回所有教师列表</a>
                                    <div style="margin-top: 10px">
                                        <form action="/public/InputTeaExcel" method="post" enctype="multipart/form-data">
                                            ...
                                            <%--                                    <a class="btn btn-primary m-r-5" href="#" > <i class="glyphicon glyphicon-plus " ></i> 导入</a>--%>
                                        </form>
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="/admin/AddTeacher" method="post" role="form" id="modalform" autocomplete="off">
                                                    <div>
                                                        ...
                                                        <div class="form-group" style="margin: 10px 30px" >
                                                            <div class="input-group-btn">
                                                                <label class="btn m-r-10 control-label" for="user_num" style="color:black">工号</label>
                                                            </div>
                                                            <input type="text" name="user_num" id="user_num" class="form-control"  placeholder="填写用户工号">
                                                        </div>
                                                        <div class="form-group" style="margin: 10px 30px">
                                                            <div class="input-group-btn">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                        <c:forEach items="${userPage.list}" var="tea">
                                            <tr style="font-size: x-small;text-align: center">
                                                <td>
                                                    <label class="lyear-checkbox checkbox-primary">
                                                        <input type="checkbox" name="id" value="${tea.getUser_num()}"><span></span>
                                                    </label>
                                                </td>
                                                <td>${tea.getId()}</td>
                                                <td>${tea.getUser_name()}</td>
                                                <td>${tea.getSex()}</td>
                                                <td>${tea.getUser_num()}</td>
                                                <td>${tea.getCol_name()}</td>
                                                <td>${tea.getDept()}</td>
                                                <td>
                                                    <div class="btn-group">
                                                        <button type="button" class="btn btn-xs btn-default" data-toggle="modal" data-target="#${tea.getUser_num()}">
                                                        ...
                                                        <a class="btn btn-xs btn-default" href="/admin/removeUser?user_num=${tea.getUser_num()}" title="" data-toggle="tooltip" data-original-title="删除"><i class="glyphicon glyphicon-trash icon2"></i></a>
                                                    </div>

                                                </td>
                                            </tr>

                                            <div class="modal fade" id="${tea.getUser_num()}" tabindex="-1" role="dialog" aria-labelledby="myModal" style="display: none;" data-backdrop="static" data-keyboard="false">
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="/admin/EditTeacherInfo" method="post" id="editTeacherInfo" >
                                                                <div>
                                                                    ...
                                                                    <div class="form-group" style="margin: 10px 30px">
                                                                        <div class="input-group-btn">
                                                                            <label class="btn control-label" for="usernum" style="color:black;margin-right: 27px">工号</label>
                                                                        </div>
                                                                        <input type="text" name="usernum" id="usernum" class="form-control" readonly="readonly" value="${tea.getUser_num()}">
                                                                    </div>
                                                                    <div class="form-group" style="margin: 10px 30px">
                                                                        <div class="input-group-btn">
                                                                    ...
                                                                    <div class="form-group" style="margin: 10px 30px">
                                                                        ...
                                                                        <input type="text" name="colname" id="colname" class="form-control"  placeholder="请输入用户所在学院">
                                                                    </div>
                                                                    <div class="form-group" style="margin: 10px 30px">
                                                                        <div class="input-group-btn">
                                ...
                                <ul class="pagination">
                                    ...
                                    <li><a href="/admin/manage_teachers?page=1&size=10" aria-label="Previous">首页</a></li>
                                    <li><a href="/admin/manage_teachers?page=${userPage.pageNum-1}&size=10">上一页</a></li>

                                    <li><a href="/admin/manage_teachers?page=${userPage.pageNum+1}&size=10">下一页</a></li>
                                    <li><a href="/admin/manage_teachers?page=${userPage.pages}&size=10" aria-label="Next">尾页</a></li>
